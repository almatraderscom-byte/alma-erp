...
export const DAILY_DUTIES = [
  ...
  { duty: 'owner_task_intake', label: '🌙 Boss-কাজ সংগ্রহ', job: 'owner-task-intake', time: '20:30' },
...
export const DUTY_CATCHUP = {
  ...
  owner_task_intake: { scheduledAfterMin: 20 * 60 + 30, catchUpUntilMin: 23 * 60, critical: false },
