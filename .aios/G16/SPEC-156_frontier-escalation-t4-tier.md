# SPEC-156 — Frontier escalation T4 tier

**Group:** G16 — Model Fabric and Provider Adapters  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-155  
**Group prerequisites:** G03, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement frontier escalation t4 tier as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-156/baseline.md
```
...
Commit with message: "SPEC-156: Frontier escalation T4 tier".
