# SPEC-152 — Deterministic T0 path

**Group:** G16 — Model Fabric and Provider Adapters  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-151  
**Group prerequisites:** G03, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement deterministic t0 path as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-152/baseline.md
```
...
Commit with message: "SPEC-152: Deterministic T0 path".
