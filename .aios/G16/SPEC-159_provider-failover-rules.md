# SPEC-159 — Provider failover rules

**Group:** G16 — Model Fabric and Provider Adapters  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-158  
**Group prerequisites:** G03, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement provider failover rules as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-159/baseline.md
```
...
Commit with message: "SPEC-159: Provider failover rules".
