# SPEC-151 — Vendor-neutral model tier contract
...
Implement vendor-neutral model tier contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-151/baseline.md
```
...
Commit with message: "SPEC-151: Vendor-neutral model tier contract".
