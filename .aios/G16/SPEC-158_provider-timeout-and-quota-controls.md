# SPEC-158 — Provider timeout and quota controls

**Group:** G16 — Model Fabric and Provider Adapters  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-157  
**Group prerequisites:** G03, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement provider timeout and quota controls as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-158/baseline.md
```
...
Commit with message: "SPEC-158: Provider timeout and quota controls".
