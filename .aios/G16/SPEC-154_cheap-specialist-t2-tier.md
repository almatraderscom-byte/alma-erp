# SPEC-154 — Cheap specialist T2 tier

**Group:** G16 — Model Fabric and Provider Adapters  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-153  
**Group prerequisites:** G03, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement cheap specialist t2 tier as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-154/baseline.md
```
...
Commit with message: "SPEC-154: Cheap specialist T2 tier".
