# SPEC-155 — Standard reasoner T3 tier

**Group:** G16 — Model Fabric and Provider Adapters  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-154  
**Group prerequisites:** G03, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement standard reasoner t3 tier as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-155/baseline.md
```
...
Commit with message: "SPEC-155: Standard reasoner T3 tier".
