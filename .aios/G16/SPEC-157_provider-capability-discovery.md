# SPEC-157 — Provider capability discovery

**Group:** G16 — Model Fabric and Provider Adapters  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-156  
**Group prerequisites:** G03, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement provider capability discovery as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-157/baseline.md
```
...
Commit with message: "SPEC-157: Provider capability discovery".
