# SPEC-153 — Classifier and extractor T1 tier

**Group:** G16 — Model Fabric and Provider Adapters  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-152  
**Group prerequisites:** G03, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement classifier and extractor t1 tier as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-153/baseline.md
```
...
Commit with message: "SPEC-153: Classifier and extractor T1 tier".
