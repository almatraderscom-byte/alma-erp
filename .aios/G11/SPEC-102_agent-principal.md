# SPEC-102 — Agent principal

**Group:** G11 — Identity Authorization and Policy Engine  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-101  
**Group prerequisites:** G01, G02, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement agent principal as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-102/baseline.md
```
...
Commit with message: "SPEC-102: Agent principal".
