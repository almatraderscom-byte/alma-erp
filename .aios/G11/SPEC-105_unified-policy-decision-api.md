# SPEC-105 — Unified policy decision API

**Group:** G11 — Identity Authorization and Policy Engine  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-104  
**Group prerequisites:** G01, G02, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement unified policy decision api as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-105/baseline.md
```
...
Commit with message: "SPEC-105: Unified policy decision API".
