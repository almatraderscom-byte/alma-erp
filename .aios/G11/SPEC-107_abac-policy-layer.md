# SPEC-107 — ABAC policy layer

**Group:** G11 — Identity Authorization and Policy Engine  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-106  
**Group prerequisites:** G01, G02, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement abac policy layer as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-107/baseline.md
```
...
Commit with message: "SPEC-107: ABAC policy layer".
