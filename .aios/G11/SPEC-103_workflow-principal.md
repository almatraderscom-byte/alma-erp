# SPEC-103 — Workflow principal

**Group:** G11 — Identity Authorization and Policy Engine  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-102  
**Group prerequisites:** G01, G02, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement workflow principal as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-103/baseline.md
```
...
Commit with message: "SPEC-103: Workflow principal".
