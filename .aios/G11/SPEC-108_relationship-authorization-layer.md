# SPEC-108 — Relationship authorization layer

**Group:** G11 — Identity Authorization and Policy Engine  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-107  
**Group prerequisites:** G01, G02, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement relationship authorization layer as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-108/baseline.md
```
...
Commit with message: "SPEC-108: Relationship authorization layer".
