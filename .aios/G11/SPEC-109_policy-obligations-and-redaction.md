# SPEC-109 — Policy obligations and redaction

**Group:** G11 — Identity Authorization and Policy Engine  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-108  
**Group prerequisites:** G01, G02, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement policy obligations and redaction as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-109/baseline.md
```
...
Commit with message: "SPEC-109: Policy obligations and redaction".
