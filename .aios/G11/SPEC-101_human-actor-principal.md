# SPEC-101 — Human actor principal
...
Implement human actor principal as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-101/baseline.md
```
...
Commit with message: "SPEC-101: Human actor principal".
