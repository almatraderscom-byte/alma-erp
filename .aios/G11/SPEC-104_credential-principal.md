# SPEC-104 — Credential principal

**Group:** G11 — Identity Authorization and Policy Engine  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-103  
**Group prerequisites:** G01, G02, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement credential principal as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-104/baseline.md
```
...
Commit with message: "SPEC-104: Credential principal".
