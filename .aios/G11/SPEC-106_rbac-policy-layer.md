# SPEC-106 — RBAC policy layer

**Group:** G11 — Identity Authorization and Policy Engine  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-105  
**Group prerequisites:** G01, G02, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement rbac policy layer as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-106/baseline.md
```
...
Commit with message: "SPEC-106: RBAC policy layer".
