# SPEC-016 — Complexity classification

**Group:** G02 — Request Admission Control Plane  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-015  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement complexity classification as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-016/baseline.md
```
...
Commit with message: "SPEC-016: Complexity classification".
