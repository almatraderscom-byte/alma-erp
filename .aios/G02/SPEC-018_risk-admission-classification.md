# SPEC-018 — Risk admission classification

**Group:** G02 — Request Admission Control Plane  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-017  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement risk admission classification as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-018/baseline.md
```
...
Commit with message: "SPEC-018: Risk admission classification".
