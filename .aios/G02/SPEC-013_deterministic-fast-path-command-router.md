# SPEC-013 — Deterministic fast-path command router

**Group:** G02 — Request Admission Control Plane  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-012  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement deterministic fast-path command router as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-013/baseline.md
```
...
Commit with message: "SPEC-013: Deterministic fast-path command router".
