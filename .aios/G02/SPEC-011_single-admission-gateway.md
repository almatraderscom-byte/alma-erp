# SPEC-011 — Single admission gateway
...
Implement single admission gateway as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-011/baseline.md
```
...
Commit with message: "SPEC-011: Single admission gateway".
