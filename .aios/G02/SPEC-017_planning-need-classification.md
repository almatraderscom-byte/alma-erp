# SPEC-017 — Planning-need classification

**Group:** G02 — Request Admission Control Plane  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-016  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement planning-need classification as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-017/baseline.md
```
...
Commit with message: "SPEC-017: Planning-need classification".
