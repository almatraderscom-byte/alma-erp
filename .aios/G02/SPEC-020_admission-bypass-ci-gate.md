# SPEC-020 — Admission bypass CI gate

**Group:** G02 — Request Admission Control Plane  
**Position in group:** 10/10  
**Direct prerequisite:** SPEC-019  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement admission bypass ci gate as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-020/baseline.md
```
...
Commit with message: "SPEC-020: Admission bypass CI gate".
