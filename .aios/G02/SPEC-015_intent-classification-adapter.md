# SPEC-015 — Intent classification adapter

**Group:** G02 — Request Admission Control Plane  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-014  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement intent classification adapter as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-015/baseline.md
```
...
Commit with message: "SPEC-015: Intent classification adapter".
