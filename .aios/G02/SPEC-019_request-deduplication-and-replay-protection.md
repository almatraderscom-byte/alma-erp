# SPEC-019 — Request deduplication and replay protection

**Group:** G02 — Request Admission Control Plane  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-018  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement request deduplication and replay protection as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-019/baseline.md
```
...
Commit with message: "SPEC-019: Request deduplication and replay protection".
