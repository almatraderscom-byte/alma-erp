# SPEC-012 — Request source normalization

**Group:** G02 — Request Admission Control Plane  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-011  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement request source normalization as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-012/baseline.md
```
...
Commit with message: "SPEC-012: Request source normalization".
