# SPEC-188 — Prompt-injection test suite

**Group:** G19 — Verification Security and Evaluation  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-187  
**Group prerequisites:** G10, G11, G13, G17, G18  
**Status:** Architecture-frozen candidate

## Mission

Implement prompt-injection test suite as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-188/baseline.md
```
...
Commit with message: "SPEC-188: Prompt-injection test suite".
