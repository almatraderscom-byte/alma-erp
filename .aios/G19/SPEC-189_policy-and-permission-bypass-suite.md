# SPEC-189 — Policy and permission bypass suite

**Group:** G19 — Verification Security and Evaluation  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-188  
**Group prerequisites:** G10, G11, G13, G17, G18  
**Status:** Architecture-frozen candidate

## Mission

Implement policy and permission bypass suite as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-189/baseline.md
```
...
Commit with message: "SPEC-189: Policy and permission bypass suite".
