# SPEC-184 — Golden task dataset

**Group:** G19 — Verification Security and Evaluation  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-183  
**Group prerequisites:** G10, G11, G13, G17, G18  
**Status:** Architecture-frozen candidate

## Mission

Implement golden task dataset as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-184/baseline.md
```
...
Commit with message: "SPEC-184: Golden task dataset".
