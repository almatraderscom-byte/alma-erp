# SPEC-187 — Cost-per-success evaluation

**Group:** G19 — Verification Security and Evaluation  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-186  
**Group prerequisites:** G10, G11, G13, G17, G18  
**Status:** Architecture-frozen candidate

## Mission

Implement cost-per-success evaluation as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-187/baseline.md
```
...
Commit with message: "SPEC-187: Cost-per-success evaluation".
