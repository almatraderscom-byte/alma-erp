# SPEC-186 — Tool-selection evaluation

**Group:** G19 — Verification Security and Evaluation  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-185  
**Group prerequisites:** G10, G11, G13, G17, G18  
**Status:** Architecture-frozen candidate

## Mission

Implement tool-selection evaluation as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-186/baseline.md
```
...
Commit with message: "SPEC-186: Tool-selection evaluation".
