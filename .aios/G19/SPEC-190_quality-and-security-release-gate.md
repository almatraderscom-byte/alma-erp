# SPEC-190 — Quality and security release gate

**Group:** G19 — Verification Security and Evaluation  
**Position in group:** 10/10  
**Direct prerequisite:** SPEC-189  
**Group prerequisites:** G10, G11, G13, G17, G18  
**Status:** Architecture-frozen candidate

## Mission

Implement quality and security release gate as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-190/baseline.md
```
...
Commit with message: "SPEC-190: Quality and security release gate".
