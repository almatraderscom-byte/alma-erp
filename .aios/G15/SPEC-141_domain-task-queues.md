...
Implement domain task queues as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-141/baseline.md
```
...
Commit with message: "SPEC-141: Domain task queues".
