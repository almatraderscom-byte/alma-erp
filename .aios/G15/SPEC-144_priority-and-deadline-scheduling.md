# SPEC-144 — Priority and deadline scheduling

**Group:** G15 — Queue Scheduling and Browser Runtime  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-143  
**Group prerequisites:** G04, G14  
**Status:** Architecture-frozen candidate

## Mission

Implement priority and deadline scheduling as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-144/baseline.md
```
...
Commit with message: "SPEC-144: Priority and deadline scheduling".
