# SPEC-142 — Tenant fairness scheduling

**Group:** G15 — Queue Scheduling and Browser Runtime  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-141  
**Group prerequisites:** G04, G14  
**Status:** Architecture-frozen candidate

## Mission

Implement tenant fairness scheduling as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-142/baseline.md
```
...
Commit with message: "SPEC-142: Tenant fairness scheduling".
