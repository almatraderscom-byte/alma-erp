# SPEC-145 — Worker lease and crash recovery

**Group:** G15 — Queue Scheduling and Browser Runtime  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-144  
**Group prerequisites:** G04, G14  
**Status:** Architecture-frozen candidate

## Mission

Implement worker lease and crash recovery as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-145/baseline.md
```
...
Commit with message: "SPEC-145: Worker lease and crash recovery".
