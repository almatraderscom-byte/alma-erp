# SPEC-149 — Browser cost and step hard stops

**Group:** G15 — Queue Scheduling and Browser Runtime  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-148  
**Group prerequisites:** G04, G14  
**Status:** Architecture-frozen candidate

## Mission

Implement browser cost and step hard stops as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-149/baseline.md
```
...
Commit with message: "SPEC-149: Browser cost and step hard stops".
