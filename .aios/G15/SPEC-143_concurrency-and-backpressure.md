# SPEC-143 — Concurrency and backpressure

**Group:** G15 — Queue Scheduling and Browser Runtime  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-142  
**Group prerequisites:** G04, G14  
**Status:** Architecture-frozen candidate

## Mission

Implement concurrency and backpressure as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-143/baseline.md
```
...
Commit with message: "SPEC-143: Concurrency and backpressure".
