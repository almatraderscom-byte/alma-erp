# SPEC-146 — Browser plan-perception-action separation

**Group:** G15 — Queue Scheduling and Browser Runtime  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-145  
**Group prerequisites:** G04, G14  
**Status:** Architecture-frozen candidate

## Mission

Implement browser plan-perception-action separation as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-146/baseline.md
```
...
Commit with message: "SPEC-146: Browser plan-perception-action separation".
