# SPEC-147 — Browser compact observation state

**Group:** G15 — Queue Scheduling and Browser Runtime  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-146  
**Group prerequisites:** G04, G14  
**Status:** Architecture-frozen candidate

## Mission

Implement browser compact observation state as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-147/baseline.md
```
...
Commit with message: "SPEC-147: Browser compact observation state".
