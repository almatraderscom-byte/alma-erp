# SPEC-148 — Browser replan limits

**Group:** G15 — Queue Scheduling and Browser Runtime  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-147  
**Group prerequisites:** G04, G14  
**Status:** Architecture-frozen candidate

## Mission

Implement browser replan limits as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-148/baseline.md
```
...
Commit with message: "SPEC-148: Browser replan limits".
