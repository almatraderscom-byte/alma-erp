# SPEC-063 — Cache-break diagnostics

**Group:** G07 — Prompt Caching and Response Caching  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-062  
**Group prerequisites:** G03, G05, G06  
**Status:** Architecture-frozen candidate

## Mission

Implement cache-break diagnostics as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-063/baseline.md
```
...
Commit with message: "SPEC-063: Cache-break diagnostics".
