# SPEC-066 — Semantic read-only response cache

**Group:** G07 — Prompt Caching and Response Caching  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-065  
**Group prerequisites:** G03, G05, G06  
**Status:** Architecture-frozen candidate

## Mission

Implement semantic read-only response cache as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-066/baseline.md
```
...
Commit with message: "SPEC-066: Semantic read-only response cache".
