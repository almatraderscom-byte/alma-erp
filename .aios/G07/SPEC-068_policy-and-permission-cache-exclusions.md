# SPEC-068 — Policy and permission cache exclusions

**Group:** G07 — Prompt Caching and Response Caching  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-067  
**Group prerequisites:** G03, G05, G06  
**Status:** Architecture-frozen candidate

## Mission

Implement policy and permission cache exclusions as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-068/baseline.md
```
...
Commit with message: "SPEC-068: Policy and permission cache exclusions".
