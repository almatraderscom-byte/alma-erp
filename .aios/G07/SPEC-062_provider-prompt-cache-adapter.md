# SPEC-062 — Provider prompt-cache adapter

**Group:** G07 — Prompt Caching and Response Caching  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-061  
**Group prerequisites:** G03, G05, G06  
**Status:** Architecture-frozen candidate

## Mission

Implement provider prompt-cache adapter as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-062/baseline.md
```
...
Commit with message: "SPEC-062: Provider prompt-cache adapter".
