# SPEC-061 — Stable-prefix hashing
...
Implement stable-prefix hashing as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-061/baseline.md
```
...
Commit with message: "SPEC-061: Stable-prefix hashing".
