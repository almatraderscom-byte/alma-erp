...
**Direct prerequisite:** SPEC-034  
**Group prerequisites:** G02, G03  
**Status:** Architecture-frozen candidate

## Mission

Implement turn budget as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-035/baseline.md
```
...
Commit with message: "SPEC-035: Turn budget".
