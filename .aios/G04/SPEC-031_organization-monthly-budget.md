# SPEC-031 — Organization monthly budget
...
Implement organization monthly budget as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-031/baseline.md
```
...
Commit with message: "SPEC-031: Organization monthly budget".
