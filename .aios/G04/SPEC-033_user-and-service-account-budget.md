# SPEC-033 — User and service-account budget

**Group:** G04 — Hard Cost Governor  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-032  
**Group prerequisites:** G02, G03  
**Status:** Architecture-frozen candidate

## Mission

Implement user and service-account budget as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-033/baseline.md
```
...
Commit with message: "SPEC-033: User and service-account budget".
