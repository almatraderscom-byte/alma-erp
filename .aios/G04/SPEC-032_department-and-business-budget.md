# SPEC-032 — Department and business budget

**Group:** G04 — Hard Cost Governor  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-031  
**Group prerequisites:** G02, G03  
**Status:** Architecture-frozen candidate

## Mission

Implement department and business budget as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-032/baseline.md
```
...
Commit with message: "SPEC-032: Department and business budget".
