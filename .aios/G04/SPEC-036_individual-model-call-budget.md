# SPEC-036 — Individual model-call budget

**Group:** G04 — Hard Cost Governor  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-035  
**Group prerequisites:** G02, G03  
**Status:** Architecture-frozen candidate

## Mission

Implement individual model-call budget as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-036/baseline.md
```
...
Commit with message: "SPEC-036: Individual model-call budget".
