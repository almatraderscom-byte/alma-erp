# SPEC-037 — Tool-loop total budget

**Group:** G04 — Hard Cost Governor  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-036  
**Group prerequisites:** G02, G03  
**Status:** Architecture-frozen candidate

## Mission

Implement tool-loop total budget as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-037/baseline.md
```
...
Commit with message: "SPEC-037: Tool-loop total budget".
