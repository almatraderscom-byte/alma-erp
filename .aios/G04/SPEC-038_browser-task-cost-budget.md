# SPEC-038 — Browser-task cost budget

**Group:** G04 — Hard Cost Governor  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-037  
**Group prerequisites:** G02, G03  
**Status:** Architecture-frozen candidate

## Mission

Implement browser-task cost budget as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-038/baseline.md
```
...
Commit with message: "SPEC-038: Browser-task cost budget".
