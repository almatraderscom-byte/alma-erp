...
**Direct prerequisite:** SPEC-033  
**Group prerequisites:** G02, G03  
**Status:** Architecture-frozen candidate

## Mission

Implement workflow budget as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-034/baseline.md
```
...
Commit with message: "SPEC-034: Workflow budget".
