# SPEC-136 — Idempotency keys

**Group:** G14 — Durable Workflow Runtime  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-135  
**Group prerequisites:** G01, G09, G13  
**Status:** Architecture-frozen candidate

## Mission

Implement idempotency keys as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-136/baseline.md
```
...
Commit with message: "SPEC-136: Idempotency keys".
