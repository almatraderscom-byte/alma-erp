# SPEC-138 — Compensation and saga actions

**Group:** G14 — Durable Workflow Runtime  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-137  
**Group prerequisites:** G01, G09, G13  
**Status:** Architecture-frozen candidate

## Mission

Implement compensation and saga actions as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-138/baseline.md
```
...
Commit with message: "SPEC-138: Compensation and saga actions".
