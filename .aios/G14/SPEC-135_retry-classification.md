# SPEC-135 — Retry classification

**Group:** G14 — Durable Workflow Runtime  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-134  
**Group prerequisites:** G01, G09, G13  
**Status:** Architecture-frozen candidate

## Mission

Implement retry classification as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-135/baseline.md
```
...
Commit with message: "SPEC-135: Retry classification".
