# SPEC-131 — Workflow template registry

**Group:** G14 — Durable Workflow Runtime  
**Position in group:** 1/10  
**Direct prerequisite:** group prerequisites only  
**Group prerequisites:** G01, G09, G13  
**Status:** Architecture-frozen candidate

## Mission

Implement workflow template registry as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-131/baseline.md
```
...
Commit with message: "SPEC-131: Workflow template registry".
