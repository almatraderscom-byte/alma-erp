# SPEC-133 — Durable workflow state

**Group:** G14 — Durable Workflow Runtime  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-132  
**Group prerequisites:** G01, G09, G13  
**Status:** Architecture-frozen candidate

## Mission

Implement durable workflow state as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-133/baseline.md
```
...
Commit with message: "SPEC-133: Durable workflow state".
