# SPEC-139 — Dead-letter and manual recovery

**Group:** G14 — Durable Workflow Runtime  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-138  
**Group prerequisites:** G01, G09, G13  
**Status:** Architecture-frozen candidate

## Mission

Implement dead-letter and manual recovery as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-139/baseline.md
```
...
Commit with message: "SPEC-139: Dead-letter and manual recovery".
