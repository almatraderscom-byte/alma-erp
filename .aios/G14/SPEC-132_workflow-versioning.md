# SPEC-132 — Workflow versioning

**Group:** G14 — Durable Workflow Runtime  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-131  
**Group prerequisites:** G01, G09, G13  
**Status:** Architecture-frozen candidate

## Mission

Implement workflow versioning as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-132/baseline.md
```
...
Commit with message: "SPEC-132: Workflow versioning".
