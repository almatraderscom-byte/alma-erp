# SPEC-134 — Step leases and heartbeats

**Group:** G14 — Durable Workflow Runtime  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-133  
**Group prerequisites:** G01, G09, G13  
**Status:** Architecture-frozen candidate

## Mission

Implement step leases and heartbeats as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-134/baseline.md
```
...
Commit with message: "SPEC-134: Step leases and heartbeats".
