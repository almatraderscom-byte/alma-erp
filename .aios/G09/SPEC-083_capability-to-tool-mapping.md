# SPEC-083 — Capability-to-tool mapping

**Group:** G09 — Capability Control Plane  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-082  
**Group prerequisites:** G02, G08  
**Status:** Architecture-frozen candidate

## Mission

Implement capability-to-tool mapping as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-083/baseline.md
```
...
Commit with message: "SPEC-083: Capability-to-tool mapping".
