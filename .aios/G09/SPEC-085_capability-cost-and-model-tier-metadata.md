# SPEC-085 — Capability cost and model-tier metadata

**Group:** G09 — Capability Control Plane  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-084  
**Group prerequisites:** G02, G08  
**Status:** Architecture-frozen candidate

## Mission

Implement capability cost and model-tier metadata as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-085/baseline.md
```
...
Commit with message: "SPEC-085: Capability cost and model-tier metadata".
