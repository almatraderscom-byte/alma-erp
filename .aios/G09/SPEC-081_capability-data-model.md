# SPEC-081 — Capability data model
...
Implement capability data model as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-081/baseline.md
```
...
Commit with message: "SPEC-081: Capability data model".
