# SPEC-087 — Capability health model

**Group:** G09 — Capability Control Plane  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-086  
**Group prerequisites:** G02, G08  
**Status:** Architecture-frozen candidate

## Mission

Implement capability health model as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-087/baseline.md
```
...
Commit with message: "SPEC-087: Capability health model".
