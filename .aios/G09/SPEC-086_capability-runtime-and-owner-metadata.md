# SPEC-086 — Capability runtime and owner metadata

**Group:** G09 — Capability Control Plane  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-085  
**Group prerequisites:** G02, G08  
**Status:** Architecture-frozen candidate

## Mission

Implement capability runtime and owner metadata as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-086/baseline.md
```
...
Commit with message: "SPEC-086: Capability runtime and owner metadata".
