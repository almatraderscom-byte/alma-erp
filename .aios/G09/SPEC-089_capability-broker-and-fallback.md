# SPEC-089 — Capability broker and fallback

**Group:** G09 — Capability Control Plane  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-088  
**Group prerequisites:** G02, G08  
**Status:** Architecture-frozen candidate

## Mission

Implement capability broker and fallback as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-089/baseline.md
```
...
Commit with message: "SPEC-089: Capability broker and fallback".
