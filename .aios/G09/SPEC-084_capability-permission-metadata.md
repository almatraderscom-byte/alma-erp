# SPEC-084 — Capability permission metadata

**Group:** G09 — Capability Control Plane  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-083  
**Group prerequisites:** G02, G08  
**Status:** Architecture-frozen candidate

## Mission

Implement capability permission metadata as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-084/baseline.md
```
...
Commit with message: "SPEC-084: Capability permission metadata".
