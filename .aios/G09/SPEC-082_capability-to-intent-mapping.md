# SPEC-082 — Capability-to-intent mapping

**Group:** G09 — Capability Control Plane  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-081  
**Group prerequisites:** G02, G08  
**Status:** Architecture-frozen candidate

## Mission

Implement capability-to-intent mapping as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-082/baseline.md
```
...
Commit with message: "SPEC-082: Capability-to-intent mapping".
