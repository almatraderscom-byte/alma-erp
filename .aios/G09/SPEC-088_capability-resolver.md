# SPEC-088 — Capability resolver

**Group:** G09 — Capability Control Plane  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-087  
**Group prerequisites:** G02, G08  
**Status:** Architecture-frozen candidate

## Mission

Implement capability resolver as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-088/baseline.md
```
...
Commit with message: "SPEC-088: Capability resolver".
