# SPEC-090 — Capability certification gate

**Group:** G09 — Capability Control Plane  
**Position in group:** 10/10  
**Direct prerequisite:** SPEC-089  
**Group prerequisites:** G02, G08  
**Status:** Architecture-frozen candidate

## Mission

Implement capability certification gate as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-090/baseline.md
```
...
Commit with message: "SPEC-090: Capability certification gate".
