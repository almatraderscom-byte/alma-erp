# SPEC-055 — Semantic long-term memory store

**Group:** G06 — Conversation State and Memory  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-054  
**Group prerequisites:** G01, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement semantic long-term memory store as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-055/baseline.md
```
...
Commit with message: "SPEC-055: Semantic long-term memory store".
