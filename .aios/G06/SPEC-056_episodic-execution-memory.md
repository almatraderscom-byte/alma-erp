...
**Direct prerequisite:** SPEC-055  
**Group prerequisites:** G01, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement episodic execution memory as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-056/baseline.md
```
...
Commit with message: "SPEC-056: Episodic execution memory".
