# SPEC-057 — Memory relevance scoring

**Group:** G06 — Conversation State and Memory  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-056  
**Group prerequisites:** G01, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement memory relevance scoring as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-057/baseline.md
```
...
Commit with message: "SPEC-057: Memory relevance scoring".
