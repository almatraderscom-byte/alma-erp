# SPEC-060 — Memory retrieval evaluation suite

**Group:** G06 — Conversation State and Memory  
**Position in group:** 10/10  
**Direct prerequisite:** SPEC-059  
**Group prerequisites:** G01, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement memory retrieval evaluation suite as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-060/baseline.md
```
...
Commit with message: "SPEC-060: Memory retrieval evaluation suite".
