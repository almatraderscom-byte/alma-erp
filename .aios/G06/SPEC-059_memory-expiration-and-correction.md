# SPEC-059 — Memory expiration and correction

**Group:** G06 — Conversation State and Memory  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-058  
**Group prerequisites:** G01, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement memory expiration and correction as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-059/baseline.md
```
...
Commit with message: "SPEC-059: Memory expiration and correction".
