# SPEC-058 — Memory privacy and tenant isolation

**Group:** G06 — Conversation State and Memory  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-057  
**Group prerequisites:** G01, G05  
**Status:** Architecture-frozen candidate

## Mission

Implement memory privacy and tenant isolation as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-058/baseline.md
```
...
Commit with message: "SPEC-058: Memory privacy and tenant isolation".
