# SPEC-122 — Schema validation stage

**Group:** G13 — Central Secure Tool Gateway  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-121  
**Group prerequisites:** G04, G10, G11, G12  
**Status:** Architecture-frozen candidate

## Mission

Implement schema validation stage as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-122/baseline.md
```
...
Commit with message: "SPEC-122: Schema validation stage".
