# SPEC-128 — Evidence capture stage

**Group:** G13 — Central Secure Tool Gateway  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-127  
**Group prerequisites:** G04, G10, G11, G12  
**Status:** Architecture-frozen candidate

## Mission

Implement evidence capture stage as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-128/baseline.md
```
...
Commit with message: "SPEC-128: Evidence capture stage".
