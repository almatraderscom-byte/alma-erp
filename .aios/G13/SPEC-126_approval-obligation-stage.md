# SPEC-126 — Approval obligation stage

**Group:** G13 — Central Secure Tool Gateway  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-125  
**Group prerequisites:** G04, G10, G11, G12  
**Status:** Architecture-frozen candidate

## Mission

Implement approval obligation stage as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-126/baseline.md
```
...
Commit with message: "SPEC-126: Approval obligation stage".
