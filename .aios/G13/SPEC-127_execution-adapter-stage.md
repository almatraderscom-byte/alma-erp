# SPEC-127 — Execution adapter stage

**Group:** G13 — Central Secure Tool Gateway  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-126  
**Group prerequisites:** G04, G10, G11, G12  
**Status:** Architecture-frozen candidate

## Mission

Implement execution adapter stage as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-127/baseline.md
```
...
Commit with message: "SPEC-127: Execution adapter stage".
