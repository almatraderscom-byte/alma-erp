# SPEC-125 — Cost authorization stage

**Group:** G13 — Central Secure Tool Gateway  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-124  
**Group prerequisites:** G04, G10, G11, G12  
**Status:** Architecture-frozen candidate

## Mission

Implement cost authorization stage as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-125/baseline.md
```
...
Commit with message: "SPEC-125: Cost authorization stage".
