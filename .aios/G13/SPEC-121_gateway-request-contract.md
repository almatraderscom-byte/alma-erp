# SPEC-121 — Gateway request contract

**Group:** G13 — Central Secure Tool Gateway  
**Position in group:** 1/10  
**Direct prerequisite:** group prerequisites only  
**Group prerequisites:** G04, G10, G11, G12  
**Status:** Architecture-frozen candidate

## Mission

Implement gateway request contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-121/baseline.md
```
...
Commit with message: "SPEC-121: Gateway request contract".
