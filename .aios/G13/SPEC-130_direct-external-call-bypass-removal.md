# SPEC-130 — Direct external-call bypass removal

**Group:** G13 — Central Secure Tool Gateway  
**Position in group:** 10/10  
**Direct prerequisite:** SPEC-129  
**Group prerequisites:** G04, G10, G11, G12  
**Status:** Architecture-frozen candidate

## Mission

Implement direct external-call bypass removal as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-130/baseline.md
```
...
Commit with message: "SPEC-130: Direct external-call bypass removal".
