...
Implement architecture inventory and request-path map as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-001/baseline.md
```
...
Commit with message: "SPEC-001: Architecture inventory and request-path map".
