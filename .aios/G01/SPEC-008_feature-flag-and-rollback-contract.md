# SPEC-008 — Feature flag and rollback contract

**Group:** G01 — Architecture Freeze and Repository Governance  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-007  
**Group prerequisites:** None  
**Status:** Architecture-frozen candidate

## Mission

Implement feature flag and rollback contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-008/baseline.md
```
...
Commit with message: "SPEC-008: Feature flag and rollback contract".
