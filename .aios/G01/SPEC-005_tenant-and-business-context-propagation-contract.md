# SPEC-005 — Tenant and business context propagation contract

**Group:** G01 — Architecture Freeze and Repository Governance  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-004  
**Group prerequisites:** None  
**Status:** Architecture-frozen candidate

## Mission

Implement tenant and business context propagation contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-005/baseline.md
```
...
Commit with message: "SPEC-005: Tenant and business context propagation contract".
