# SPEC-007 — Architecture decision record process

**Group:** G01 — Architecture Freeze and Repository Governance  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-006  
**Group prerequisites:** None  
**Status:** Architecture-frozen candidate

## Mission

Implement architecture decision record process as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-007/baseline.md
```
...
Commit with message: "SPEC-007: Architecture decision record process".
