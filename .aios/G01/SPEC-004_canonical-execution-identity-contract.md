# SPEC-004 — Canonical execution identity contract

**Group:** G01 — Architecture Freeze and Repository Governance  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-003  
**Group prerequisites:** None  
**Status:** Architecture-frozen candidate

## Mission

Implement canonical execution identity contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-004/baseline.md
```
...
Commit with message: "SPEC-004: Canonical execution identity contract".
