# SPEC-006 — Canonical error taxonomy

**Group:** G01 — Architecture Freeze and Repository Governance  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-005  
**Group prerequisites:** None  
**Status:** Architecture-frozen candidate

## Mission

Implement canonical error taxonomy as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-006/baseline.md
```
...
Commit with message: "SPEC-006: Canonical error taxonomy".
