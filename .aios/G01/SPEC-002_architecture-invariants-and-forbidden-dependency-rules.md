# SPEC-002 — Architecture invariants and forbidden dependency rules

**Group:** G01 — Architecture Freeze and Repository Governance  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-001  
**Group prerequisites:** None  
**Status:** Architecture-frozen candidate

## Mission

Implement architecture invariants and forbidden dependency rules as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-002/baseline.md
```
...
Commit with message: "SPEC-002: Architecture invariants and forbidden dependency rules".
