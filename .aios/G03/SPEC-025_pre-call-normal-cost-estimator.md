...
**Direct prerequisite:** SPEC-024  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement pre-call normal cost estimator as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-025/baseline.md
```
...
Commit with message: "SPEC-025: Pre-call normal cost estimator".
