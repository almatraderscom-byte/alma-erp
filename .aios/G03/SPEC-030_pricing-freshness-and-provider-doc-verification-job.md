# SPEC-030 — Pricing freshness and provider-doc verification job

**Group:** G03 — Provider Pricing and Cost Accounting  
**Position in group:** 10/10  
**Direct prerequisite:** SPEC-029  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement pricing freshness and provider-doc verification job as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-030/baseline.md
```
...
Commit with message: "SPEC-030: Pricing freshness and provider-doc verification job".
