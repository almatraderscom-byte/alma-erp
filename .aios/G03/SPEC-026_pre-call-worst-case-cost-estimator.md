# SPEC-026 — Pre-call worst-case cost estimator

**Group:** G03 — Provider Pricing and Cost Accounting  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-025  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement pre-call worst-case cost estimator as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-026/baseline.md
```
...
Commit with message: "SPEC-026: Pre-call worst-case cost estimator".
