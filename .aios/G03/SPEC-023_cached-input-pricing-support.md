# SPEC-023 — Cached-input pricing support

**Group:** G03 — Provider Pricing and Cost Accounting  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-022  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement cached-input pricing support as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-023/baseline.md
```
...
Commit with message: "SPEC-023: Cached-input pricing support".
