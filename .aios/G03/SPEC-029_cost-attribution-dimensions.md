# SPEC-029 — Cost attribution dimensions

**Group:** G03 — Provider Pricing and Cost Accounting  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-028  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement cost attribution dimensions as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-029/baseline.md
```
...
Commit with message: "SPEC-029: Cost attribution dimensions".
