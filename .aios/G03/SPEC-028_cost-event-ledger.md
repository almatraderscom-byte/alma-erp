# SPEC-028 — Cost event ledger

**Group:** G03 — Provider Pricing and Cost Accounting  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-027  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement cost event ledger as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-028/baseline.md
```
...
Commit with message: "SPEC-028: Cost event ledger".
