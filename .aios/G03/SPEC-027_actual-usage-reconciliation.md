# SPEC-027 — Actual usage reconciliation

**Group:** G03 — Provider Pricing and Cost Accounting  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-026  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement actual usage reconciliation as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-027/baseline.md
```
...
Commit with message: "SPEC-027: Actual usage reconciliation".
