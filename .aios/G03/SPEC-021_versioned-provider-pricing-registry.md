# SPEC-021 — Versioned provider pricing registry
...
Implement versioned provider pricing registry as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-021/baseline.md
```
...
Commit with message: "SPEC-021: Versioned provider pricing registry".
