# SPEC-022 — Tokenizer abstraction and token estimation

**Group:** G03 — Provider Pricing and Cost Accounting  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-021  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement tokenizer abstraction and token estimation as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-022/baseline.md
```
...
Commit with message: "SPEC-022: Tokenizer abstraction and token estimation".
