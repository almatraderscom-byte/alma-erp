# SPEC-024 — Reasoning and tool-call cost accounting

**Group:** G03 — Provider Pricing and Cost Accounting  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-023  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement reasoning and tool-call cost accounting as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-024/baseline.md
```
...
Commit with message: "SPEC-024: Reasoning and tool-call cost accounting".
