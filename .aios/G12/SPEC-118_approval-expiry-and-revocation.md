# SPEC-118 — Approval expiry and revocation

**Group:** G12 — Autonomy and Approval Governance  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-117  
**Group prerequisites:** G04, G11  
**Status:** Architecture-frozen candidate

## Mission

Implement approval expiry and revocation as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-118/baseline.md
```
...
Commit with message: "SPEC-118: Approval expiry and revocation".
