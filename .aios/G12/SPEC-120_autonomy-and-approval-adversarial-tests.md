# SPEC-120 — Autonomy and approval adversarial tests

**Group:** G12 — Autonomy and Approval Governance  
**Position in group:** 10/10  
**Direct prerequisite:** SPEC-119  
**Group prerequisites:** G04, G11  
**Status:** Architecture-frozen candidate

## Mission

Implement autonomy and approval adversarial tests as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-120/baseline.md
```
...
Commit with message: "SPEC-120: Autonomy and approval adversarial tests".
