# SPEC-117 — Separation-of-duties enforcement

**Group:** G12 — Autonomy and Approval Governance  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-116  
**Group prerequisites:** G04, G11  
**Status:** Architecture-frozen candidate

## Mission

Implement separation-of-duties enforcement as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-117/baseline.md
```
...
Commit with message: "SPEC-117: Separation-of-duties enforcement".
