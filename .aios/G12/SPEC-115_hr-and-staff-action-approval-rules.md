# SPEC-115 — HR and staff action approval rules

**Group:** G12 — Autonomy and Approval Governance  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-114  
**Group prerequisites:** G04, G11  
**Status:** Architecture-frozen candidate

## Mission

Implement hr and staff action approval rules as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-115/baseline.md
```
...
Commit with message: "SPEC-115: HR and staff action approval rules".
