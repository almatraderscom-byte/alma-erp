# SPEC-113 — Financial action approval rules

**Group:** G12 — Autonomy and Approval Governance  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-112  
**Group prerequisites:** G04, G11  
**Status:** Architecture-frozen candidate

## Mission

Implement financial action approval rules as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-113/baseline.md
```
...
Commit with message: "SPEC-113: Financial action approval rules".
