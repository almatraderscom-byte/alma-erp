# SPEC-111 — Autonomy decision states
...
Implement autonomy decision states as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-111/baseline.md
```
...
Commit with message: "SPEC-111: Autonomy decision states".
