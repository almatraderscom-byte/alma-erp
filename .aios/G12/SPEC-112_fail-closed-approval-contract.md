# SPEC-112 — Fail-closed approval contract

**Group:** G12 — Autonomy and Approval Governance  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-111  
**Group prerequisites:** G04, G11  
**Status:** Architecture-frozen candidate

## Mission

Implement fail-closed approval contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-112/baseline.md
```
...
Commit with message: "SPEC-112: Fail-closed approval contract".
