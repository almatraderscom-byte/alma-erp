# SPEC-114 — External publishing approval rules

**Group:** G12 — Autonomy and Approval Governance  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-113  
**Group prerequisites:** G04, G11  
**Status:** Architecture-frozen candidate

## Mission

Implement external publishing approval rules as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-114/baseline.md
```
...
Commit with message: "SPEC-114: External publishing approval rules".
