# SPEC-179 — Specialist retry and repair policy

**Group:** G18 — Specialist Agents and Known Workflows  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-178  
**Group prerequisites:** G09, G14, G17  
**Status:** Architecture-frozen candidate

## Mission

Implement specialist retry and repair policy as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-179/baseline.md
```
...
Commit with message: "SPEC-179: Specialist retry and repair policy".
