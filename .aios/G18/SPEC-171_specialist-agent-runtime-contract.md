# SPEC-171 — Specialist agent runtime contract

**Group:** G18 — Specialist Agents and Known Workflows  
**Position in group:** 1/10  
**Direct prerequisite:** group prerequisites only  
**Group prerequisites:** G09, G14, G17  
**Status:** Architecture-frozen candidate

## Mission

Implement specialist agent runtime contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-171/baseline.md
```
...
Commit with message: "SPEC-171: Specialist agent runtime contract".
