# SPEC-174 — Customer-support workflow templates

**Group:** G18 — Specialist Agents and Known Workflows  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-173  
**Group prerequisites:** G09, G14, G17  
**Status:** Architecture-frozen candidate

## Mission

Implement customer-support workflow templates as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-174/baseline.md
```
...
Commit with message: "SPEC-174: Customer-support workflow templates".
