# SPEC-172 — Schema-constrained specialist output

**Group:** G18 — Specialist Agents and Known Workflows  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-171  
**Group prerequisites:** G09, G14, G17  
**Status:** Architecture-frozen candidate

## Mission

Implement schema-constrained specialist output as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-172/baseline.md
```
...
Commit with message: "SPEC-172: Schema-constrained specialist output".
