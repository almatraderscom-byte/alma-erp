# SPEC-178 — External communication workflows

**Group:** G18 — Specialist Agents and Known Workflows  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-177  
**Group prerequisites:** G09, G14, G17  
**Status:** Architecture-frozen candidate

## Mission

Implement external communication workflows as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-178/baseline.md
```
...
Commit with message: "SPEC-178: External communication workflows".
