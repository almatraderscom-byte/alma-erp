# SPEC-173 — Marketing workflow templates

**Group:** G18 — Specialist Agents and Known Workflows  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-172  
**Group prerequisites:** G09, G14, G17  
**Status:** Architecture-frozen candidate

## Mission

Implement marketing workflow templates as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-173/baseline.md
```
...
Commit with message: "SPEC-173: Marketing workflow templates".
