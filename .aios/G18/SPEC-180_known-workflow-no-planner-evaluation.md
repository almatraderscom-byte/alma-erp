# SPEC-180 — Known-workflow no-planner evaluation

**Group:** G18 — Specialist Agents and Known Workflows  
**Position in group:** 10/10  
**Direct prerequisite:** SPEC-179  
**Group prerequisites:** G09, G14, G17  
**Status:** Architecture-frozen candidate

## Mission

Implement known-workflow no-planner evaluation as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-180/baseline.md
```
...
Commit with message: "SPEC-180: Known-workflow no-planner evaluation".
