# SPEC-176 — ERP and office workflow templates

**Group:** G18 — Specialist Agents and Known Workflows  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-175  
**Group prerequisites:** G09, G14, G17  
**Status:** Architecture-frozen candidate

## Mission

Implement erp and office workflow templates as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-176/baseline.md
```
...
Commit with message: "SPEC-176: ERP and office workflow templates".
