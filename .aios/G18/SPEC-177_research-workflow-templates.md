# SPEC-177 — Research workflow templates

**Group:** G18 — Specialist Agents and Known Workflows  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-176  
**Group prerequisites:** G09, G14, G17  
**Status:** Architecture-frozen candidate

## Mission

Implement research workflow templates as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-177/baseline.md
```
...
Commit with message: "SPEC-177: Research workflow templates".
