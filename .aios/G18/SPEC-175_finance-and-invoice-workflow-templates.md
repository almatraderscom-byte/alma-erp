# SPEC-175 — Finance and invoice workflow templates

**Group:** G18 — Specialist Agents and Known Workflows  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-174  
**Group prerequisites:** G09, G14, G17  
**Status:** Architecture-frozen candidate

## Mission

Implement finance and invoice workflow templates as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-175/baseline.md
```
...
Commit with message: "SPEC-175: Finance and invoice workflow templates".
