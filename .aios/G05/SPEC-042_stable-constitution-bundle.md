# SPEC-042 — Stable constitution bundle

**Group:** G05 — Prompt and Context Compiler  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-041  
**Group prerequisites:** G01, G02, G04  
**Status:** Architecture-frozen candidate

## Mission

Implement stable constitution bundle as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-042/baseline.md
```
...
Commit with message: "SPEC-042: Stable constitution bundle".
