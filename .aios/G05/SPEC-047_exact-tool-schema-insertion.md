# SPEC-047 — Exact tool-schema insertion

**Group:** G05 — Prompt and Context Compiler  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-046  
**Group prerequisites:** G01, G02, G04  
**Status:** Architecture-frozen candidate

## Mission

Implement exact tool-schema insertion as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-047/baseline.md
```
...
Commit with message: "SPEC-047: Exact tool-schema insertion".
