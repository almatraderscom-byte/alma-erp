# SPEC-041 — Versioned context compiler contract

**Group:** G05 — Prompt and Context Compiler  
**Position in group:** 1/10  
**Direct prerequisite:** group prerequisites only  
**Group prerequisites:** G01, G02, G04  
**Status:** Architecture-frozen candidate

## Mission

Implement versioned context compiler contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-041/baseline.md
```
...
Commit with message: "SPEC-041: Versioned context compiler contract".
