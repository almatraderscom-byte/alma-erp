...
**Direct prerequisite:** SPEC-042  
**Group prerequisites:** G01, G02, G04  
**Status:** Architecture-frozen candidate

## Mission

Implement domain skill bundle as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-043/baseline.md
```
...
Commit with message: "SPEC-043: Domain skill bundle".
