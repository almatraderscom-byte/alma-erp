# SPEC-049 — Context token allocator

**Group:** G05 — Prompt and Context Compiler  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-048  
**Group prerequisites:** G01, G02, G04  
**Status:** Architecture-frozen candidate

## Mission

Implement context token allocator as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-049/baseline.md
```
...
Commit with message: "SPEC-049: Context token allocator".
