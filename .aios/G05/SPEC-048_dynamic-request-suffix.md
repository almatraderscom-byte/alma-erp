# SPEC-048 — Dynamic request suffix

**Group:** G05 — Prompt and Context Compiler  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-047  
**Group prerequisites:** G01, G02, G04  
**Status:** Architecture-frozen candidate

## Mission

Implement dynamic request suffix as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-048/baseline.md
```
...
Commit with message: "SPEC-048: Dynamic request suffix".
