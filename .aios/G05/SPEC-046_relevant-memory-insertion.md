# SPEC-046 — Relevant memory insertion

**Group:** G05 — Prompt and Context Compiler  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-045  
**Group prerequisites:** G01, G02, G04  
**Status:** Architecture-frozen candidate

## Mission

Implement relevant memory insertion as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-046/baseline.md
```
...
Commit with message: "SPEC-046: Relevant memory insertion".
