# SPEC-044 — Policy bundle insertion

**Group:** G05 — Prompt and Context Compiler  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-043  
**Group prerequisites:** G01, G02, G04  
**Status:** Architecture-frozen candidate

## Mission

Implement policy bundle insertion as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-044/baseline.md
```
...
Commit with message: "SPEC-044: Policy bundle insertion".
