# SPEC-198 — Model bake-off automation

**Group:** G20 — Observability Release and Continuous Optimization  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-197  
**Group prerequisites:** G07, G14, G19  
**Status:** Architecture-frozen candidate

## Mission

Implement model bake-off automation as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-198/baseline.md
```
...
Commit with message: "SPEC-198: Model bake-off automation".
