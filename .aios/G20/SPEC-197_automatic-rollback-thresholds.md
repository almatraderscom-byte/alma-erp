# SPEC-197 — Automatic rollback thresholds

**Group:** G20 — Observability Release and Continuous Optimization  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-196  
**Group prerequisites:** G07, G14, G19  
**Status:** Architecture-frozen candidate

## Mission

Implement automatic rollback thresholds as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-197/baseline.md
```
...
Commit with message: "SPEC-197: Automatic rollback thresholds".
