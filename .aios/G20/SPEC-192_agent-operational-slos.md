# SPEC-192 — Agent operational SLOs

**Group:** G20 — Observability Release and Continuous Optimization  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-191  
**Group prerequisites:** G07, G14, G19  
**Status:** Architecture-frozen candidate

## Mission

Implement agent operational slos as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-192/baseline.md
```
...
Commit with message: "SPEC-192: Agent operational SLOs".
