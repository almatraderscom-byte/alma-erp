# SPEC-195 — Shadow traffic framework

**Group:** G20 — Observability Release and Continuous Optimization  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-194  
**Group prerequisites:** G07, G14, G19  
**Status:** Architecture-frozen candidate

## Mission

Implement shadow traffic framework as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-195/baseline.md
```
...
Commit with message: "SPEC-195: Shadow traffic framework".
