# SPEC-080 — Monolithic registry removal gate

**Group:** G08 — Tool Registry Decomposition  
**Position in group:** 10/10  
**Direct prerequisite:** SPEC-079  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement monolithic registry removal gate as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-080/baseline.md
```
...
Commit with message: "SPEC-080: Monolithic registry removal gate".
