# SPEC-077 — Tool versioning

**Group:** G08 — Tool Registry Decomposition  
**Position in group:** 7/10  
**Direct prerequisite:** SPEC-076  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement tool versioning as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-077/baseline.md
```
...
Commit with message: "SPEC-077: Tool versioning".
