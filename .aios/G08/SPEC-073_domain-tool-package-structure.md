# SPEC-073 — Domain tool package structure

**Group:** G08 — Tool Registry Decomposition  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-072  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement domain tool package structure as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-073/baseline.md
```
...
Commit with message: "SPEC-073: Domain tool package structure".
