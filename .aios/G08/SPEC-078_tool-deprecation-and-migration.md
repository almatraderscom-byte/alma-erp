# SPEC-078 — Tool deprecation and migration

**Group:** G08 — Tool Registry Decomposition  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-077  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement tool deprecation and migration as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-078/baseline.md
```
...
Commit with message: "SPEC-078: Tool deprecation and migration".
