# SPEC-074 — Tool input/output schema registry

**Group:** G08 — Tool Registry Decomposition  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-073  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement tool input/output schema registry as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-074/baseline.md
```
...
Commit with message: "SPEC-074: Tool input/output schema registry".
