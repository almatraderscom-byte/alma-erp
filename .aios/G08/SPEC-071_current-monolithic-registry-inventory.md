# SPEC-071 — Current monolithic registry inventory

**Group:** G08 — Tool Registry Decomposition  
**Position in group:** 1/10  
**Direct prerequisite:** group prerequisites only  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement current monolithic registry inventory as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-071/baseline.md
```
...
Commit with message: "SPEC-071: Current monolithic registry inventory".
