# SPEC-072 — Tool manifest schema

**Group:** G08 — Tool Registry Decomposition  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-071  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement tool manifest schema as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-072/baseline.md
```
...
Commit with message: "SPEC-072: Tool manifest schema".
