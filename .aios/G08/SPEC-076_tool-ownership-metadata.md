# SPEC-076 — Tool ownership metadata

**Group:** G08 — Tool Registry Decomposition  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-075  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement tool ownership metadata as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-076/baseline.md
```
...
Commit with message: "SPEC-076: Tool ownership metadata".
