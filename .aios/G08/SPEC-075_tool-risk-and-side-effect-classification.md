# SPEC-075 — Tool risk and side-effect classification

**Group:** G08 — Tool Registry Decomposition  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-074  
**Group prerequisites:** G01  
**Status:** Architecture-frozen candidate

## Mission

Implement tool risk and side-effect classification as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-075/baseline.md
```
...
Commit with message: "SPEC-075: Tool risk and side-effect classification".
