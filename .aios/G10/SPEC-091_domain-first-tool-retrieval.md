# SPEC-091 — Domain-first tool retrieval
...
Implement domain-first tool retrieval as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-091/baseline.md
```
...
Commit with message: "SPEC-091: Domain-first tool retrieval".
