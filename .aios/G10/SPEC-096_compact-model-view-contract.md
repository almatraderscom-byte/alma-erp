# SPEC-096 — Compact model-view contract

**Group:** G10 — Tool Selection and Tool Result Firewall  
**Position in group:** 6/10  
**Direct prerequisite:** SPEC-095  
**Group prerequisites:** G05, G08, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement compact model-view contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-096/baseline.md
```
...
Commit with message: "SPEC-096: Compact model-view contract".
