# SPEC-095 — Full evidence payload storage

**Group:** G10 — Tool Selection and Tool Result Firewall  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-094  
**Group prerequisites:** G05, G08, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement full evidence payload storage as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-095/baseline.md
```
...
Commit with message: "SPEC-095: Full evidence payload storage".
