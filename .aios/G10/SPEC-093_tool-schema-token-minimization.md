# SPEC-093 — Tool schema token minimization

**Group:** G10 — Tool Selection and Tool Result Firewall  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-092  
**Group prerequisites:** G05, G08, G09  
**Status:** Architecture-frozen candidate

## Mission

Implement tool schema token minimization as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-093/baseline.md
```
...
Commit with message: "SPEC-093: Tool schema token minimization".
