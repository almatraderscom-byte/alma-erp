# SPEC-170 — Routing and head-isolation regression gate

**Group:** G17 — Measured Routing and Head Model Isolation  
**Position in group:** 10/10  
**Direct prerequisite:** SPEC-169  
**Group prerequisites:** G04, G09, G16  
**Status:** Architecture-frozen candidate

## Mission

Implement routing and head-isolation regression gate as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-170/baseline.md
```
...
Commit with message: "SPEC-170: Routing and head-isolation regression gate".
