# SPEC-163 — Latency and availability score

**Group:** G17 — Measured Routing and Head Model Isolation  
**Position in group:** 3/10  
**Direct prerequisite:** SPEC-162  
**Group prerequisites:** G04, G09, G16  
**Status:** Architecture-frozen candidate

## Mission

Implement latency and availability score as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-163/baseline.md
```
...
Commit with message: "SPEC-163: Latency and availability score".
