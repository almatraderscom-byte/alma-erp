# SPEC-168 — Frontier head planner contract

**Group:** G17 — Measured Routing and Head Model Isolation  
**Position in group:** 8/10  
**Direct prerequisite:** SPEC-167  
**Group prerequisites:** G04, G09, G16  
**Status:** Architecture-frozen candidate

## Mission

Implement frontier head planner contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-168/baseline.md
```
...
Commit with message: "SPEC-168: Frontier head planner contract".
