# SPEC-169 — Head-model tool-loop prohibition

**Group:** G17 — Measured Routing and Head Model Isolation  
**Position in group:** 9/10  
**Direct prerequisite:** SPEC-168  
**Group prerequisites:** G04, G09, G16  
**Status:** Architecture-frozen candidate

## Mission

Implement head-model tool-loop prohibition as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-169/baseline.md
```
...
Commit with message: "SPEC-169: Head-model tool-loop prohibition".
