# SPEC-162 — Cost-quality model score

**Group:** G17 — Measured Routing and Head Model Isolation  
**Position in group:** 2/10  
**Direct prerequisite:** SPEC-161  
**Group prerequisites:** G04, G09, G16  
**Status:** Architecture-frozen candidate

## Mission

Implement cost-quality model score as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-162/baseline.md
```
...
Commit with message: "SPEC-162: Cost-quality model score".
