# SPEC-161 — Task-class model performance records

**Group:** G17 — Measured Routing and Head Model Isolation  
**Position in group:** 1/10  
**Direct prerequisite:** group prerequisites only  
**Group prerequisites:** G04, G09, G16  
**Status:** Architecture-frozen candidate

## Mission

Implement task-class model performance records as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-161/baseline.md
```
...
Commit with message: "SPEC-161: Task-class model performance records".
