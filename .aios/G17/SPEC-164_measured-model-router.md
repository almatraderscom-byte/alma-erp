# SPEC-164 — Measured model router

**Group:** G17 — Measured Routing and Head Model Isolation  
**Position in group:** 4/10  
**Direct prerequisite:** SPEC-163  
**Group prerequisites:** G04, G09, G16  
**Status:** Architecture-frozen candidate

## Mission

Implement measured model router as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-164/baseline.md
```
...
Commit with message: "SPEC-164: Measured model router".
