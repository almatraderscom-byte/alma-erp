# SPEC-165 — Explicit escalation reason contract

**Group:** G17 — Measured Routing and Head Model Isolation  
**Position in group:** 5/10  
**Direct prerequisite:** SPEC-164  
**Group prerequisites:** G04, G09, G16  
**Status:** Architecture-frozen candidate

## Mission

Implement explicit escalation reason contract as a production-grade, typed, audited and testable boundary for Alma ERP.
...
```text
artifacts/SPEC-165/baseline.md
```
...
Commit with message: "SPEC-165: Explicit escalation reason contract".
