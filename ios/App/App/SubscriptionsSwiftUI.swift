...
struct SubscriptionsScreen: View {
    ...
    private var heroGrid: some View {
        HStack(spacing: 11) {
            ...
            .frame(maxWidth: .infinity, alignment: .leading).padding(16).subRaised(scheme, corner: 20)
            VStack(alignment: .leading, spacing: 0) {
            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(spacing: 9) {
                    ForEach(vm.upcoming.prefix(6)) { s in
                        ...
                        .padding(.leading, 9).padding(.trailing, 13).padding(.vertical, 9).subGlass(scheme, corner: 13)
                    }
    ...
    private func stat(_ v: String, _ k: String, _ c: Color) -> some View {
        ...
        }.frame(maxWidth: .infinity).padding(12).subSolid(scheme, corner: 15)
    }
    ...
    private func subCard(_ s: Subscription) -> some View {
        ...
        .padding(16).subSolid(scheme, corner: 20)
        .contextMenu {
    ...
    private var loadingRows: some View {
        ForEach(0..<4, id: \.self) { _ in Color.clear.frame(height: 108).subSolid(scheme, corner: 20) }
    }
