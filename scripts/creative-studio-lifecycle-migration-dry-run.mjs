...
const ROADMAP_FIELDS = [
  ...
  ['compositionId', ['compositionId', 'composition_id']],
  ['compositionVersionId', ['compositionVersionId', 'composition_version_id']],
  ['compositionVersion', ['compositionVersion', 'composition_version']],
  ['compositionDocumentHash', ['compositionDocumentHash', 'composition_document_hash']],
  ['operationBatchId', ['operationBatchId', 'operation_batch_id']],
  ['approvedReviewEventId', ['approvedReviewEventId', 'approved_review_event_id']],
  ['reviewFingerprint', ['reviewFingerprint', 'review_fingerprint']],
  ['renderFingerprint', ['renderFingerprint', 'render_fingerprint']],
  ['costBdt', ['costBdt', 'cost_bdt', 'estimatedCostBdt', 'estimated_cost_bdt']],
...
if (!path || path.startsWith('-')) {
  ...
  const report = {
    ...
    sourceByOwner: countBy(sourceRows, 'ownerId'),
    targetByOwner: countBy(targetRows, 'ownerId'),
    sourceByBrand: countBy(sourceRows, 'brandProfileId'),
    targetByBrand: countBy(targetRows, 'brandProfileId'),
    sourceByProject: countBy(sourceRows, 'projectId'),
    targetByProject: countBy(targetRows, 'projectId'),
