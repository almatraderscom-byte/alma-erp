...
const utm_build: AgentTool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      adsetKey: { type: 'string', description: 'Ad-set identifier for utm_content lineage (slugified)' },
      adKey: { type: 'string', description: 'Ad identifier for utm_content lineage (slugified)' },
      creativeKey: { type: 'string', description: 'Creative identifier for utm_content lineage (slugified)' },
