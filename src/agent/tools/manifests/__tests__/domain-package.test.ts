...
describe('SPEC-073 generated packages', () => {
  it('partitions the full monolith surface (355 manifests, 64 domains)', () => {
    expect(manifestCount()).toBe(355)
    expect(ALL_MANIFESTS.length).toBe(355)
    expect(domains().length).toBe(64)
  })
