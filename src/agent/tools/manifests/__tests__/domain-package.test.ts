...
describe('SPEC-073 generated packages', () => {
  it('partitions the full monolith surface (358 manifests, 64 domains)', () => {
    expect(manifestCount()).toBe(358)
    expect(ALL_MANIFESTS.length).toBe(358)
