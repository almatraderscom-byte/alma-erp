...
describe('SPEC-073 generated packages', () => {
  it('partitions the full monolith surface (360 manifests, 64 domains)', () => {
    expect(manifestCount()).toBe(360)
    expect(ALL_MANIFESTS.length).toBe(360)
