      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            aria-label="উপরে যান"
            className="pointer-events-auto flex h-10 w-10 items-center justify-center rounded-full border border-black/[0.08] bg-white/95 text-gray-500 shadow-lg backdrop-blur-md transition-colors hover:text-[#E07A5F] active:scale-95"
          >
