...
export function buildCorrectionNoticeMessage(
  ...
  if (situation === 'new_already_sent') {
    return (
      `⚠️ ALMA টিম — গুরুত্বপূর্ণ নোটিশ\n\n` +
      `আস্সালামু আলাইকুম ${name} ভাই!\n\n` +
      `আমরা জানাচ্ছি — আগে যে টাস্ক লিস্ট পাঠানো হয়েছিল সেটি বাতিল করা হয়েছে, ওই তালিকা অনুসরণ করবেন না।\n\n` +
      `আপনার কাছে ঠিক মাত্র পাঠানো "📋 আজকের কাজ" লিস্টটিই সঠিক — শুধুমাত্র সেই নতুন তালিকা অনুযায়ী কাজ করুন।\n\n` +
      `আমরা একসাথে কাজ করে এগিয়ে যাই। জাযাকাল্লাহু খয়রান। 🙏\n\n— ALMA টিম`
    )
  }
  return (
    `⚠️ ALMA টিম — গুরুত্বপূর্ণ নোটিশ\n\n` +
    `আস্সালামু আলাইকুম ${name} ভাই!\n\n` +
    `আমরা জানাচ্ছি — আগের টাস্ক লিস্ট বাতিল হয়েছে। নতুন সঠিক টাস্ক লিস্ট শীঘ্রই পাঠানো হবে — ততক্ষণ অপেক্ষা করুন।\n\n` +
    `জাযাকাল্লাহু খয়রান। 🙏\n\n— ALMA টিম`
  )
}
