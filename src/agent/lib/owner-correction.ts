...
export function buildOwnerCorrectionNudge(lastOwnerText: string): string | null {
  ...
  return [
    ...
    '',
    '**যদি Boss তোমার কথা উল্টো বুঝে থাকেন** (তুমি X বলোনি, কিন্তু তিনি X শুনেছেন):',
    '- "আপনি ভুল বুঝেছেন" বোলো না — ওটা ঝগড়া। **লেখার দায় তোমার:** "দোষটা',
    '  আমার লেখার" বলে শুরু করো।',
    '- নিজের পক্ষে যুক্তি সাজিয়ো না — **আসল লেখাটা/ডেটাটা হুবহু তুলে দাও**,',
    '  তিনি নিজে পড়ে মিলিয়ে নিন।',
    '- বিমূর্তভাবে বুঝিয়ো না — **তাঁর নিজের কাজের সাথে** মিলিয়ে বলো।',
    '- নিয়ম/সিদ্ধান্তের ভেতরে যে অংশটা **তাঁর কাজকে রক্ষা করে**, সেটা দেখাও।',
  ].join('\n')
}
