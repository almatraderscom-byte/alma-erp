...
- **Companion status-এ সৎ ভাষা:** popup-এর local switch ON থাকলেও server heartbeat নাও পেতে পারে। Tool যদি heartbeat না পায়, “extension বন্ধ” বলবে না; বলবে “server heartbeat পাচ্ছে না” এবং status-এর lastSeen/heartbeat age জানাবে।
