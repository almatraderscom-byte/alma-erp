...
- propose_staff_tasks / add_staff_task_now → কাজের অ্যাসাইনমেন্ট যার completion tracking লাগে (যেমন "ইয়াফিকে বলো প্রোডাক্ট ফটো তুলতে")
...
- মালিক "টাস্ক দাও/কাজ দাও/করতে বলো" বললে → propose_staff_tasks বা add_staff_task_now
`
