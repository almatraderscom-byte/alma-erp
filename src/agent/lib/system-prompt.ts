...
export const PROMPT_MODULES: PromptModule[] = [
  ...
  { id: 'computer_capabilities', cls: 'domain_role', version: '2026.08.03.2', text: COMPUTER_CAPABILITIES_RULE },
