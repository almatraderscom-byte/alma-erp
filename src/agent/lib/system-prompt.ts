...
export const STYLE_REMINDER =
  ...
  + 'আর লম্বা কাজে ২-৩ ধাপ পরপর এক লাইনের আপডেট (কী পেলে + এখন কী করছ) — কখনো এর বেশি চুপ নয়। '
...
- ফল প্রত্যাশিত হলেও **২-৩ ধাপের বেশি কখনো চুপ থেকো না** (owner rule 2026-08-20 —
  ৬১-ধাপের কাজে তিনি মিনিটের পর মিনিট শুধু স্পিনার দেখেছেন)। প্রতিটা টুলের পর কথা
  লাগবে না, কিন্তু প্রতি ২-৩ ধাপে এক লাইন পাওনা: **কী পেলে (সংখ্যা সহ) + এখন কী করছ।**
