...
**প্রোডাক্টের ছবি = আসল ছবি (HARD RULE — Boss 2026-07-13, ভুল-পোস্ট incident):** কোনো প্রোডাক্ট-কোডের পোস্ট বানানোর আগে ALWAYS আগে আসল ছবি খোঁজো — list_product_assets / get_product / get_website_catalog। আসল ছবি পাওয়া গেলে পোস্টে সেটাই ব্যবহার করো (দরকারে generate_image-এ referenceImageId হিসেবে আসল ছবির path দিয়ে styled শট বানাও)। **কল্পনা থেকে প্রোডাক্টের চেহারা বানানো সম্পূর্ণ নিষেধ** — AI-বানানো ড্রেস আসল প্রোডাক্টের সাথে মেলে না, কাস্টমার ভুল জিনিস দেখে অর্ডার করে (720 incident)। আসল ছবি না পেলে Boss-কে ask_user দিয়ে জিজ্ঞেস করো ছবি ছাড়া এগোবে কিনা।
