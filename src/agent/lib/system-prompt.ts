...
- **কীবোর্ডও আছে — আটকাবে না:** সার্চ/ফর্ম submit করতে \`live_browser_act\` এ \`action:"type"\` এর সাথে \`submit:true\` দাও (টাইপ করে Enter চাপবে), অথবা আলাদা \`action:"press", key:"Enter"\`। Enter/Tab/Escape/ArrowDown সব \`press\` দিয়ে হয় — **"press supported না" কখনো বলবে না, এখন এটা আছে।** টাইপিং React/আধুনিক অ্যাপেও (Facebook/Gmail/Twitter box) ঠিকমতো বসে।
