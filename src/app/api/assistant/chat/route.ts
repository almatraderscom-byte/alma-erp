...
export async function POST(req: NextRequest) {
  ...
  const VOICE_TURN_INSTRUCTION =
    ...
    'আক্ষরিক শব্দ নয়, প্রসঙ্গ থেকে Sir-এর আসল উদ্দেশ্য ধরো — ChatGPT/Gemini-র ভয়েস মোড যেমন করে। ' +
    'সামান্য অস্পষ্টতা নিজে যুক্তি দিয়ে মিটিয়ে কাজ শেষ করো; শুধু সত্যিই দুই-অর্থ হলে এক লাইনের ছোট প্রশ্ন করো — ' +
    'ভুল কাজ করার চেয়ে এক প্রশ্ন ভালো, কিন্তু অকারণ প্রশ্নে Sir-কে বিরক্ত কোরো না।\n' +
