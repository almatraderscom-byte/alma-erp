  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Link href="/inventory" className="text-[11px] font-semibold text-muted hover:text-cream">
            ← Back to inventory
          </Link>
        }
      />
      ...
      <div className="p-4 md:p-6 pb-24 space-y-4 max-w-6xl mx-auto">
        <Card className="p-4 border-gold/20 bg-gold/[0.04]">
          ...
          <div className="text-[11px] text-muted space-y-3">
            <p>
            ...
            <ol className="list-decimal pl-4 space-y-2 text-muted">
              <li>
                ...
                <pre className="mt-1 p-2 rounded-lg bg-white/[0.04] border border-border text-[10px] text-gold/90 overflow-x-auto whitespace-pre-wrap">
              ...
              <li>
                ...
                <pre className="mt-1 p-2 rounded-lg bg-white/[0.04] border border-border text-[10px] text-gold/90 overflow-x-auto">
                  {cdpCommand}
                </pre>
        ...
        <Card className="p-4 border-gold-dim/30">
          ...
          <textarea
            ...
            className="w-full min-h-[140px] bg-white/[0.03] border border-border rounded-xl p-3 text-xs font-mono text-cream focus:outline-none focus:border-gold-dim/50"
          />
        ...
        <Card className="p-4">
          ...
          <p className="text-[11px] text-muted mb-3">Map supplier category labels to your PRODUCT MASTER categories.</p>
                  ...
                  {filtered.map(r => {
                    ...
                    return (
                      <tr key={r._rowId} className="border-b border-border/40 hover:bg-white/[0.02]">
                        ...
                        <td className="px-2 py-2 text-muted truncate max-w-[120px]">{r.supplier_product_id || '—'}</td>
                        <td className="px-2 py-2 text-right tabular-nums">{Number(r.default_price ?? r.price ?? 0)}</td>
                        <td className="px-2 py-2 text-muted truncate max-w-[120px]">{r._mappedCategory}</td>
                        <td className="px-2 py-2">
                          {r.image_url || r.image ? (
                            ...
                            <img
                              ...
                              width={40}
                              height={40}
                              className="rounded-md object-cover border border-border bg-white/[0.03]"
                              loading="lazy"
                            />
                          ) : (
                            <span className="text-muted-hi">—</span>
        ...
        <Card className="p-4 border-gold-dim/20">
          ...
          {commitLoading && (
            <div className="mt-3">
              ...
              <p className="text-[10px] text-muted-hi mt-1">Writing to Google Sheets…</p>
            </div>
          )}
        </Card>
        ...
        <Card className="p-4">
          <h2 className="text-xs font-bold tracking-wider text-muted mb-2">Import log</h2>
          <pre className="text-[10px] text-muted font-mono whitespace-pre-wrap max-h-48 overflow-y-auto">
