...
export default function AgentLoading() {
  return (
    <div className="flex h-full min-h-0 flex-col bg-transparent">
      {/* Header placeholder */}
      <div className="safe-top safe-x flex shrink-0 items-center gap-3 border-b border-border-subtle bg-card/60 backdrop-blur-2xl px-3 py-2.5 md:px-4">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-4 px-6">
        ...
        />
        <div className="h-3.5 w-40 rounded-md bg-white/[0.05]" />
      ...
      <div className="safe-x shrink-0 px-3 pb-[max(12px,env(safe-area-inset-bottom))] pt-2 md:px-5 md:pb-5">
        <div className="h-12 w-full rounded-2xl border border-border bg-card/60 backdrop-blur-2xl" />
      </div>
