...
export default function TradingHrPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeUp} className="grid grid-cols-2 gap-3 md:grid-cols-4 xl:grid-cols-8">
        ...
        <KpiCard label="Commissions" value={data?.kpis.totalCommissions ?? 0} color="text-gold" loading={loading} />
        <KpiCard label="Wallet balance" value={data?.kpis.totalWalletBalance ?? 0} color="text-blue-500" loading={loading} />
        <KpiCard label="Missing reports" value={data?.kpis.missingReports ?? 0} color="text-amber-500" loading={loading} />
      </motion.div>
      ...
      <motion.div variants={fadeUp} className="grid gap-4 xl:grid-cols-5">
