...
export function ProfilePhotoSection({
  ...
  return (
    <section
      id="profile-photo"
      className="scroll-mt-24 rounded-2xl border border-gold-dim/35 bg-gradient-to-br from-gold/[0.08] via-[#0c0c10] to-[#09090d] p-5 sm:p-6 shadow-[0_0_40px_rgba(214,169,74,0.08)]"
    >
