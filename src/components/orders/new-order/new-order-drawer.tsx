        ...
        <div className="mobile-modal-header border-b border-border bg-surface/95 backdrop-blur md:backdrop-blur-none">
          ...
          <div className="flex items-center justify-between px-4 py-3 sm:px-5 sm:py-4">
            ...
            <button
              ...
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-border bg-card/70 text-cream shadow-sm backdrop-blur-md transition-all hover:bg-card active:scale-95"
            >
