  ...
  return (
    <button
      ...
      className={cn(
        ...
        'shadow-sm transition-colors hover:border-gold/30 hover:bg-gold/[0.05]',
        'max-w-full',
        className,
      )}
    ...
    >
      ...
      {unread > 0 && (
        <span className="shrink-0 rounded-full bg-gold px-2 py-0.5 text-[10px] font-black text-white">
          {unread > 99 ? '99+' : unread}
        </span>
      )}
      {criticalUnacked > 0 && (
