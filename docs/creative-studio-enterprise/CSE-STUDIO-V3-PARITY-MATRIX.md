...
| Deterministic Agent edit | new demo contract `demo-operations.ts` and tests | Project Editor Agent | Plan, safe-vs-gated diff, fingerprint `8F2C`, acknowledgement, three reversible ৳0 edits, version-derived audit ID, rollback as a new version. |
