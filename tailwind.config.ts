  ...
  theme: {
    extend: {
      colors: {
        ...
        danger: 'var(--danger)',
        info: 'var(--info)',
        // iOS 27 tokens (src/styles/ios27.css) — extracted from Apple's
        // official iOS/iPadOS 27 Figma kit. Fixed rgba/hex vars, so Tailwind
        // alpha modifiers don't apply; use the semantic shade variants.
        ios: {
          red: 'var(--ios-red)',
          ...
          brown: 'var(--ios-brown)',
          label: 'var(--ios-label)',
          'label-2': 'var(--ios-label-secondary)',
          'label-3': 'var(--ios-label-tertiary)',
          'label-4': 'var(--ios-label-quaternary)',
          fill: 'var(--ios-fill-primary)',
          'fill-2': 'var(--ios-fill-secondary)',
          'fill-3': 'var(--ios-fill-tertiary)',
          'fill-4': 'var(--ios-fill-quaternary)',
          bg: 'var(--ios-bg-primary)',
          'bg-2': 'var(--ios-bg-secondary)',
          'bg-3': 'var(--ios-bg-tertiary)',
          grouped: 'var(--ios-grouped-primary)',
          'grouped-2': 'var(--ios-grouped-secondary)',
          'grouped-3': 'var(--ios-grouped-tertiary)',
