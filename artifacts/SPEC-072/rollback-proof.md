...
## Result (actual)
```
parent_tree = 395aabfa9a7869926e87eb483b3f87d8800a2eb0
revert_tree = 395aabfa9a7869926e87eb483b3f87d8800a2eb0
...
then restored (git reset --hard), leaving exactly one commit for SPEC-072.
