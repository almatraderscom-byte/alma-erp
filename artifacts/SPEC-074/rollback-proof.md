...
## Result (actual)
```
parent_tree = 41cab06d5709540a552152cc7832678a095b26a7
revert_tree = 41cab06d5709540a552152cc7832678a095b26a7
...
then restored (git reset --hard), leaving exactly one commit for SPEC-074.
