...
## Result (actual)
```
parent_tree = b545b74e7055f3b8a85570f736afff29124ac6d1
revert_tree = b545b74e7055f3b8a85570f736afff29124ac6d1
...
then restored (git reset --hard), leaving exactly one commit for SPEC-077.
